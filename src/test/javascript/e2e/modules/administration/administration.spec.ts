...
describe('Administration', () => {
  ...
  it('should load metrics', async () => {
    ...
    await waitUntilDisplayed(heading);
    expect(await heading.getText()).to.eq('Application Metrics');
  });
  ...
  it('should load health', async () => {
    ...
    await waitUntilDisplayed(heading);
    expect(await heading.getText()).to.eq('Health Checks');
  });
  ...
  it('should load configuration', async () => {
    ...
    await waitUntilDisplayed(heading);
    expect(await heading.getText()).to.eq('Configuration');
  });
  ...
  it('should load audits', async () => {
    ...
    await waitUntilDisplayed(heading);
    expect(await heading.getText()).to.eq('Audits');
  });
  ...
  it('should load logs', async () => {
    ...
    await waitUntilDisplayed(heading);
    expect(await heading.getText()).to.eq('Logs');
  });
